...
function dtoController(cls: JavaClass, project: JavaProject): string {
...
function entityController(cls: JavaClass, project: JavaProject): string {
  const cn = cls.className
  return `package ${project.basePackage}.controller;
...
export function controllerGenerator(cls: JavaClass, project: JavaProject): string {
