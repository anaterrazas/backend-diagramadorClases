...
function entityImports(cls: JavaClass): string[] {
  const imports = new Set<string>()
  imports.add('jakarta.persistence.Entity')
  if (cls.fields.some((f) => f.isId)) imports.add('jakarta.persistence.Id')
...
export function entityGenerator(cls: JavaClass, basePackage: string): string {
  const lines: string[] = []
