...
export function generateCreatePageFile(flutterClass: FlutterClass): FlutterFile {
...
export function generateCreatePageFiles(project: FlutterProject): FlutterFile[] {
