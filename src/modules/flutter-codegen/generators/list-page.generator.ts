...
export function generateListPageFile(flutterClass: FlutterClass): FlutterFile {
...
export function generateListPageFiles(project: FlutterProject): FlutterFile[] {
  return project.classes.map(generateListPageFile)
}

function fieldValue(field: FlutterField): string {
