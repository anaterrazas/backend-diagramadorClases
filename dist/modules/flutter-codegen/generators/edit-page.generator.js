...
exports.generateEditPageFile = generateEditPageFile;
exports.generateEditPageFiles = generateEditPageFiles;
function generateEditPageFile(flutterClass) {
...
function generateEditPageFiles(project) {
...
function generateLoadAssignment(field) {
    if (field.isRelation)
        return `          _${field.dartName} = it.${field.dartName};\n`;
    if (field.dartType === 'bool')
        return `          ${field.dartName} = it.${field.dartName};\n`;
    if (field.dartType === 'DateTime')
        return `          ${field.dartName} = it.${field.dartName};\n`;
